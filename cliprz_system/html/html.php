<?php
	 ...
	 *
	 * File information :
	 *  File path BASE_PATH/cliprz_system/html/ .
	 *  File name html.php .
	 *  Created date 23/1/2013 9:56 PM.
	 *  Last modification date 23/1/2013 11:39 PM.
	 *
	 * Description :
	...
	if ( !function_exists('c_html_meta')) {
		 ...
		 * @param (string) $name    - The name of meta (can you use charset and
		 * http-equiv)
